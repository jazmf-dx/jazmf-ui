...
見た目のボタングループだが、選択の意味はラジオボタンと同じ（どれか1つ）。
...
| 場面 | 代わりに使うもの |
|---|---|
| 選択肢が多い（6個以上） | \`select.input-field\`（省スペース） |
| 複数選択したい | \`input[type=checkbox]\` のリスト |
| 補足説明を選択肢ごとに添えたい | \`input[type=radio]\` の縦並び（説明文を置ける） |
